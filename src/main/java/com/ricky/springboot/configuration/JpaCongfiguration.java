package com.ricky.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.ricky.springboot.repositories", entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionmanager")
...
public class JpaCongfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() throws NamingException{
		...
		factoryBean.setPackagesToScan(new String[] { "com.ricky.springboot.model" });
